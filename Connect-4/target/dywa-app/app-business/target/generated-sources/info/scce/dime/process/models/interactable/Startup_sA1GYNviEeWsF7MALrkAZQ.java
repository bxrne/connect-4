package info.scce.dime.process.models.interactable;
...
public final class Startup_sA1GYNviEeWsF7MALrkAZQ implements DIMEProcess {
	...
	@Inject
	public Startup_sA1GYNviEeWsF7MALrkAZQ(final BeanManager beanManager, de.ls5.dywa.generated.controller.models.app.ConcreteUserController ConcreteUserController) {
	...
	public SIB_ID execute_PXMhsNzNEeWtAOZsxPLKSA(final Context ctx) {
		...
		final de.ls5.dywa.generated.entity.models.app.ConcreteUser searchObject = domController.createSearchObject("");
		final List<de.ls5.dywa.generated.entity.models.app.ConcreteUser> result = domController.findByProperties(searchObject);
		if (result.isEmpty()) {
			// branch 'none found'
