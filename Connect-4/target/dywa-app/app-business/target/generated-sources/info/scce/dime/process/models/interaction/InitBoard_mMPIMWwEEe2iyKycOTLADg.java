...
public final class InitBoard_mMPIMWwEEe2iyKycOTLADg implements DIMEProcess {
	...
	public SIB_ID execute_P6QM0W0VEe2yX46ZtG__HYPHEN_MINUS__Oww(final Context ctx) {
		try {
			final List<java.lang.Long> result = info.scce.dime.app.demo.Game.makeEmptyColumn(6l);
			List<java.lang.Long> value2 = result;
			if (value2 != null) { // prevent null in lists
			ctx.MakeEmptyColumnSuccessColumn_P68wYW0VEe2yX46ZtG__HYPHEN_MINUS__Oww = new ArrayList<java.lang.Long>(value2);
			}
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public SIB_ID execute_4lEkMW0WEe2yX46ZtG__HYPHEN_MINUS__Oww(final Context ctx) {
		try {
			final List<java.lang.Long> result = info.scce.dime.app.demo.Game.makeIndexList(7l);
			List<java.lang.Long> value3 = result;
			if (value3 != null) { // prevent null in lists
			ctx.MakeIndexListSuccessIndexes_4lnWwW0WEe2yX46ZtG__HYPHEN_MINUS__Oww = new ArrayList<java.lang.Long>(value3);
			}
		}
		catch (Exception e) {
			e.printStackTrace();
