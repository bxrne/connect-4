package info.scce.dime.process.models.basic;
...
public final class CreateUser_cBxicNzDEeW2rv4DARGjjw implements DIMEProcess {
	...
	private final de.ls5.dywa.generated.controller.models.app.ConcreteUserController ConcreteUserController;
	private final de.ls5.dywa.generated.controller.models.app.BaseUserController BaseUserController;

	@Inject
	public CreateUser_cBxicNzDEeW2rv4DARGjjw(final BeanManager beanManager, de.ls5.dywa.generated.controller.models.app.ConcreteUserController ConcreteUserController, de.ls5.dywa.generated.controller.models.app.BaseUserController BaseUserController) {
	...
	// model branches.
		...
		public interface SuccessReturn {
			public de.ls5.dywa.generated.entity.models.app.ConcreteUser getNewUser();
		}
	...
	public SIB_ID execute_dig8cNzDEeW2rv4DARGjjw(final Context ctx) {
		...
		Optional.ofNullable(ctx.baseuser).map(de.ls5.dywa.generated.entity.models.app.BaseUser::getconcreteUser_ConcreteUser).get().add(value0);
		}
	...
	public SIB_ID execute_eKUjUNzDEeW2rv4DARGjjw(final Context ctx) {
		final de.ls5.dywa.generated.controller.models.app.BaseUserController domController = this.BaseUserController;
