	...
	public class AuthenticationImpl implements info.scce.dime.auth.AuthenticationInterface {
		...
		@javax.inject.Inject
		private de.ls5.dywa.generated.controller.models.app.BaseUserController controller;
		...
		public org.apache.shiro.authc.AuthenticationInfo doGetAuthenticationInfo(org.apache.shiro.authc.AuthenticationToken token) throws org.apache.shiro.authc.AuthenticationException {
			...
			final de.ls5.dywa.generated.entity.models.app.BaseUser user;

			final de.ls5.dywa.generated.entity.models.app.BaseUser searchObject = controller.createSearchObject(null);
			searchObject.setusername(userName);

			final java.util.List<de.ls5.dywa.generated.entity.models.app.BaseUser> users = controller.findByProperties(searchObject);
