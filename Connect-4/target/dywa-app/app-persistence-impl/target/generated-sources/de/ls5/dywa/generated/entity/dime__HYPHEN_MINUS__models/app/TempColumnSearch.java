...
public class TempColumnSearch implements TempColumn {
	...
	static {
		java.lang.Class<?> targetClass = TempColumnImpl.class;
	...
	public TempColumnSearch() {
		this((java.lang.String  )null);
	}
	
	public TempColumnSearch(java.lang.String name) {
	...
	public java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Cell> getcell_Cell() {
		return (java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Cell>) this.listAttributeMap.get(dywaIdToJpqlAttr.get(18L));
	}
	public void setcell_Cell
	(java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Cell> object) {
			
				for(de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Cell p: object){
					 if (! (p instanceof de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Cell)) {
							throw new java.lang.RuntimeException("Wrong type");
				}
				}
			this.listAttributeMap.put(dywaIdToJpqlAttr.get(18L), object);
	}
