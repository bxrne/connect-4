...
public class BaseUserSearch implements BaseUser {
	...
	public java.util.List<de.ls5.dywa.generated.entity.models.app.ConcreteUser> getconcreteUser_ConcreteUser() {
		return (java.util.List<de.ls5.dywa.generated.entity.models.app.ConcreteUser>) this.listAttributeMap.get(dywaIdToJpqlAttr.get(8L));
	}
	public void setconcreteUser_ConcreteUser
	(java.util.List<de.ls5.dywa.generated.entity.models.app.ConcreteUser> object) {
			
				for(de.ls5.dywa.generated.entity.models.app.ConcreteUser p: object){
					 if (! (p instanceof de.ls5.dywa.generated.entity.models.app.ConcreteUser)) {
							throw new java.lang.RuntimeException("Wrong type");
				}
				}
			this.listAttributeMap.put(dywaIdToJpqlAttr.get(8L), object);
	}
	@java.lang.Override
	public java.lang.String getpassword() {
		return (java.lang.String) this.attributeMap.get(dywaIdToJpqlAttr.get(9L));
	}
	...
	public de.ls5.dywa.generated.util.FileReference getimage() {
		return new de.ls5.dywa.generated.util.FileReference((de.ls5.dywa.generated.util.DomainFile) this.attributeMap.get(dywaIdToJpqlAttr.get(10L)));
	}
	...
	(de.ls5.dywa.generated.util.FileReference object) {
			...
			this.attributeMap.put(dywaIdToJpqlAttr.get(10L), object != null ? object.getDelegate() : null);
	}
	@java.lang.Override
