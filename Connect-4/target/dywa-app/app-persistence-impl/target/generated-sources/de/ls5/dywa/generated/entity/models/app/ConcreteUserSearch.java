...
public class ConcreteUserSearch implements ConcreteUser {
	...
	public de.ls5.dywa.generated.entity.models.app.BaseUser getbaseUser() {
		return (de.ls5.dywa.generated.entity.models.app.BaseUser) this.attributeMap.get(dywaIdToJpqlAttr.get(7L));
	}
	public void setbaseUser
	(de.ls5.dywa.generated.entity.models.app.BaseUser object) {
			
				if (! (object instanceof de.ls5.dywa.generated.entity.models.app.BaseUser)) {
	...
	public de.ls5.dywa.generated.entity.models.app.ConcreteUser getdywaSwitchedTo() {
		return (de.ls5.dywa.generated.entity.models.app.ConcreteUser) this.attributeMap.get(dywaIdToJpqlAttr.get(8L));
	}
