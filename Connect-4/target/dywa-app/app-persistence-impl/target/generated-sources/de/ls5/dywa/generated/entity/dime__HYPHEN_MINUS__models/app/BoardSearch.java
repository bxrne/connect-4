...
public class BoardSearch implements Board {
	...
	static {
		java.lang.Class<?> targetClass = BoardImpl.class;
	...
	public BoardSearch(java.lang.String name) {
	...
	public java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Column> getcolumns_Column() {
		return (java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Column>) this.listAttributeMap.get(dywaIdToJpqlAttr.get(14L));
	}
	public void setcolumns_Column
	(java.util.List<de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Column> object) {
			
				for(de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Column p: object){
					 if (! (p instanceof de.ls5.dywa.generated.entity.dime__HYPHEN_MINUS__models.app.Column)) {
