...
public class TempColumnSearch implements TempColumn {
	...
	public java.util.List<de.ls5.dywa.generated.entity.models.app.Cell> getcell_Cell() {
		return (java.util.List<de.ls5.dywa.generated.entity.models.app.Cell>) this.listAttributeMap.get(dywaIdToJpqlAttr.get(18L));
	}
	public void setcell_Cell
	(java.util.List<de.ls5.dywa.generated.entity.models.app.Cell> object) {
			
				for(de.ls5.dywa.generated.entity.models.app.Cell p: object){
					 if (! (p instanceof de.ls5.dywa.generated.entity.models.app.Cell)) {
