...
public class BoardSearch implements Board {
	...
	public java.util.List<de.ls5.dywa.generated.entity.models.app.Column> getcolumns_Column() {
		return (java.util.List<de.ls5.dywa.generated.entity.models.app.Column>) this.listAttributeMap.get(dywaIdToJpqlAttr.get(16L));
	}
	public void setcolumns_Column
	(java.util.List<de.ls5.dywa.generated.entity.models.app.Column> object) {
			
				for(de.ls5.dywa.generated.entity.models.app.Column p: object){
					 if (! (p instanceof de.ls5.dywa.generated.entity.models.app.Column)) {
							throw new java.lang.RuntimeException("Wrong type");
				}
				}
			this.listAttributeMap.put(dywaIdToJpqlAttr.get(16L), object);
	}
