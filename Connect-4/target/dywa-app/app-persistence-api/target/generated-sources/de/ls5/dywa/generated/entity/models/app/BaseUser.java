...
public interface BaseUser extends de.ls5.dywa.generated.util.Identifiable {
	...
	// CUSTOM LIST IMPL
	static class CustomListImpl<T extends de.ls5.dywa.generated.util.Identifiable> extends java.util.AbstractList<de.ls5.dywa.generated.entity.models.app.BaseUser> {
	
		private final java.util.List<de.ls5.dywa.generated.entity.models.app.BaseUser> delegate;
		private final BiDirectionalHelper<T> bidirectionalHelper;
		private boolean bidirectionalDirtyFlag;
	
		public CustomListImpl(final java.util.List<de.ls5.dywa.generated.entity.models.app.BaseUser> delegate) {
			this(delegate, null);
		}
	
		public CustomListImpl(final java.util.List<de.ls5.dywa.generated.entity.models.app.BaseUser> delegate, final BiDirectionalHelper<T> bidirectionalHelper) {
		...
		@java.lang.Override
		public de.ls5.dywa.generated.entity.models.app.BaseUser get(int index) {
				return this.delegate.get(index);
		}
	
		@java.lang.Override
		public de.ls5.dywa.generated.entity.models.app.BaseUser set(int index, de.ls5.dywa.generated.entity.models.app.BaseUser element) {
	
			final de.ls5.dywa.generated.entity.models.app.BaseUser replaced = this.delegate.set(index, element);
		...
		@java.lang.Override
		public void add(int index, de.ls5.dywa.generated.entity.models.app.BaseUser element) {
		...
		@java.lang.Override
		public de.ls5.dywa.generated.entity.models.app.BaseUser remove(int index) {
	
			if (!this.bidirectionalDirtyFlag) {
	
				this.bidirectionalDirtyFlag = true;
				final de.ls5.dywa.generated.entity.models.app.BaseUser result = this.delegate.remove(index);
	...
	static class BiDirectionalHelper<T extends de.ls5.dywa.generated.util.Identifiable> {
		...
		final java.util.function.BiConsumer<de.ls5.dywa.generated.entity.models.app.BaseUser, T> setter;
		final java.util.function.Function<de.ls5.dywa.generated.entity.models.app.BaseUser, java.util.List<T>> getter;
		final T owner;
	
		public BiDirectionalHelper(
				java.util.function.BiConsumer<de.ls5.dywa.generated.entity.models.app.BaseUser, T> setter,
				T owner) {
		...
		public BiDirectionalHelper(
				java.util.function.Function<de.ls5.dywa.generated.entity.models.app.BaseUser, java.util.List<T>> getter,
				T owner) {
		...
		public void setReference(final de.ls5.dywa.generated.entity.models.app.BaseUser p) {
		...
		public void clearReference(final de.ls5.dywa.generated.entity.models.app.BaseUser p) {
