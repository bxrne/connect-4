...
public class Game {
	...
	//DEBUG:returns string representation of the board
	...
	public static boolean checkWin(Board _board, Long player) {
		//build 2d array from DIME Board object to use original game logic
		int width = _board.getcolumns_Column().size(); //number of Columns
		int height = _board.getcolumns_Column().get(0).getcells_Cell().size(); //number of Cells per Column 
		...
		//horizontal
		//leftmost 3 cells aren't checked as cells will be out of bounds
